...
f = open('tweets_#superbowl.txt', 'r', encoding = 'utf-8')
...
X_train = np.array([tweet_num[:-1], retweet_num[:-1],mention_num[:-1], Cooccurrence_times[:-1] , favorite_count[:-1],  np.ones(len(tweet_num)-1)])
X_train = X_train.T
